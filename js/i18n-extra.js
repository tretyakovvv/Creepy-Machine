(function () {
  const extra = {
    fr: {
      ...
      subscription: { title: "Ouvrez l'abîme", subtitle: "Plus de générations", free: "Gratuit", perMonth: "/ mois", generations: "{n} générations / mois", subscribe: "S'abonner", currentPlan: "Votre plan", popular: "Populaire", paymentNote: "Paiement YooKassa", success: "Paiement réussi.", pending: "En attente..." },
    ...
    it: {
      ...
      subscription: { title: "Sblocca l'abisso", subtitle: "Più generazioni", subscribe: "Abbonati", currentPlan: "Il tuo piano", popular: "Popolare", perMonth: "/ mese", generations: "{n} generazioni / mese", paymentNote: "Pagamenti YooKassa", success: "Pagamento riuscito.", pending: "In attesa...", free: "Gratis" },
    ...
    ja: {
      ...
      subscription: { title: "深淵を解放", subtitle: "より多くの生成", subscribe: "登録", currentPlan: "現在のプラン", popular: "人気", perMonth: "/ 月", generations: "{n} 回/月", paymentNote: "YooKassa", success: "支払い成功。", pending: "処理中...", free: "無料" },
    ...
    ko: {
      ...
      subscription: { title: "심연 해제", subtitle: "더 많은 생성", subscribe: "구독", currentPlan: "현재 플랜", popular: "인기", perMonth: "/ 월", generations: "{n}회/월", paymentNote: "YooKassa", success: "결제 성공.", pending: "대기 중...", free: "무료" },
    ...
    zh: {
      ...
      subscription: { title: "解锁深渊", subtitle: "更多生成", subscribe: "订阅", currentPlan: "当前方案", popular: "热门", perMonth: "/ 月", generations: "{n}次/月", paymentNote: "YooKassa", success: "支付成功。", pending: "处理中...", free: "免费" },

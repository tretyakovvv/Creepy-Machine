(function () {
  const extra = {
    fr: {
      ...
      subscription: { title: "Ouvrez l'abîme", subtitle: "Plus de générations, service prioritaire et modèle IA plus puissant et plus stable pour les abonnés", free: "Gratuit", perMonth: "/ mois", generations: "{n} générations / mois", subscribe: "S'abonner", currentPlan: "Votre plan", popular: "Populaire", premiumOnly: "Abonnement requis", paymentNote: "Paiement YooKassa", success: "Paiement réussi.", pending: "En attente..." },
    ...
    it: {
      ...
      subscription: { title: "Sblocca l'abisso", subtitle: "Più generazioni, servizio prioritario e un modello IA più potente e stabile per gli abbonati", subscribe: "Abbonati", currentPlan: "Il tuo piano", popular: "Popolare", premiumOnly: "Solo abbonamento", perMonth: "/ mese", generations: "{n} generazioni / mese", paymentNote: "Pagamenti YooKassa", success: "Pagamento riuscito.", pending: "In attesa...", free: "Gratis" },
    ...
    ja: {
      ...
      subscription: { title: "深淵を解放", subtitle: "より多くの生成、優先対応、そしてより強力で安定したAIモデルを利用可能", subscribe: "登録", currentPlan: "現在のプラン", popular: "人気", premiumOnly: "登録者限定", perMonth: "/ 月", generations: "{n} 回/月", paymentNote: "YooKassa", success: "支払い成功。", pending: "処理中...", free: "無料" },
    ...
    ko: {
      ...
      subscription: { title: "심연 해제", subtitle: "더 많은 생성, 우선 서비스, 그리고 더 강력하고 안정적인 AI 모델", subscribe: "구독", currentPlan: "현재 플랜", popular: "인기", premiumOnly: "구독 전용", perMonth: "/ 월", generations: "{n}회/월", paymentNote: "YooKassa", success: "결제 성공.", pending: "대기 중...", free: "무료" },
    ...
    zh: {
      ...
      subscription: { title: "解锁深渊", subtitle: "更多生成，优先服务，以及更强大、更稳定的 AI 模型", subscribe: "订阅", currentPlan: "当前方案", popular: "热门", premiumOnly: "仅订阅可用", perMonth: "/ 月", generations: "{n}次/月", paymentNote: "YooKassa", success: "支付成功。", pending: "处理中...", free: "免费" },
